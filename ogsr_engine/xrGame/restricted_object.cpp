                                         ...
                                         const xr_vector<ALife::_OBJECT_ID>& in_restrictions)
{
	...
	START_PROFILE("Restricted Object/Add Restrictions")
		...
		construct_restriction_string<CRestrictionPredicate<true>, true>(temp_out_restrictions, out_restrictions,
		                                                                this->out_restrictions(),
		                                                                CRestrictionPredicate<true>(
			                                                                RestrictionSpace::eRestrictorTypeOut));
		construct_restriction_string<CRestrictionPredicate<true>, true>(temp_in_restrictions, in_restrictions,
