...
class_<CScriptGameObject> script_register_game_object2(class_<CScriptGameObject>&& instance)
{
	return std::move(instance)
	       ...
	       .def("play_sound",
	            (void (CScriptGameObject::*)(u32, u32, u32, u32, u32, u32))(&CScriptGameObject::play_sound))
	       ...
	       .def("best_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, float))(&
		            CScriptGameObject::best_cover))
	       .def("best_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, const Fvector&, float, float, float,
	                                                        const luabind::functor<bool>&))(&CScriptGameObject::
		            best_cover))
	       .def("safe_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, float, float))(&CScriptGameObject::
		            safe_cover))
	       .def("safe_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, float, float, const luabind::functor<bool>&)
	            )(&CScriptGameObject::safe_cover))
	       .def("ambush_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, const Fvector&, float, float))(&
		            CScriptGameObject::ambush_cover))
	       .def("ambush_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, const Fvector&, float, float,
	                                                        const luabind::functor<bool>&))(&CScriptGameObject::
		            ambush_cover))
	       .def("angle_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, float, const Fvector&, float, float, u32))(&
		            CScriptGameObject::angle_cover))
	       .def("angle_cover",
	            (const CCoverPoint* ( CScriptGameObject::*)(const Fvector&, float, const Fvector&, float, float, u32,
	                                                        const luabind::functor<bool>&))(&CScriptGameObject::
		            angle_cover))
	       ...
	       // sight manager
	       .def("set_sight",
	            (void (CScriptGameObject::*)(SightManager::ESightType sight_type, const Fvector* vector3d,
	       ...
	       .def("set_item",
	            (void (CScriptGameObject::*)(MonsterSpace::EObjectAction, CScriptGameObject*))(&CScriptGameObject::
		            set_item))
	       .def("set_item",
		...
		.def("give_task",					&CScriptGameObject::GiveTaskToActor, adopt(_2))
	       ...
	       .def("play_hud_animation",
	            (void (CScriptGameObject::*)(LPCSTR, bool))(&CScriptGameObject::play_hud_animation))

	       .def("add_feel_touch",
	            (void ( CScriptGameObject::*)(float, const luabind::object&, const luabind::functor<void>&,
	                                          const luabind::functor<bool>&))(&CScriptGameObject::addFeelTouch))
	       .def("add_feel_touch",
	            (void ( CScriptGameObject::*)(float, const luabind::object&, const luabind::functor<void>&))(&
		            CScriptGameObject::addFeelTouch))
	       .def("remove_feel_touch",
	            (void ( CScriptGameObject::*)(const luabind::object&, const luabind::functor<void>&,
	                                          const luabind::functor<bool>&))(&CScriptGameObject::removeFeelTouch))
	       .def("remove_feel_touch",
	            (void ( CScriptGameObject::*)(const luabind::object&, const luabind::functor<void>&))(&CScriptGameObject
		            ::removeFeelTouch));
}
