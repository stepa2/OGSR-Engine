...
private:
	...
	IC _edge_value_type estimate_edge_weight_impl_help(const _index_type& vertex_index, Bool2Type<false>) const
	{
		return estimate_edge_weight_impl(vertex_index);
	}

	IC _edge_value_type estimate_edge_weight_impl_help(const _index_type& vertex_index, Bool2Type<true>) const
	{
...
public:
	...
	IC bool evaluate_condition(typename xr_vector<COperatorCondition>::const_iterator& I,
