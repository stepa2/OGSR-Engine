...
u8 CMissile::idle_state()
{
	...
	if (actor)
		...
		else if (actor->is_actor_running() || actor->is_actor_walking() || actor->is_actor_creeping() || actor->
			is_actor_crouching())
