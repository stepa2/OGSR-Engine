...
u16 CPHSimpleCharacter::RetriveContactBone()
{
	...
	else
	{
		...
		pos_in_object.sub(m_collision_damage_info.HitPos(), object->Position());
...
u16 CPHSimpleCharacter::DamageInitiatorID() const
{
	...
	CPhysicsShellHolder* object = static_cast<CPhysicsShellHolder*>(Level()
	                                                                .Objects.net_Find(m_collision_damage_info.m_obj_id)
	);
