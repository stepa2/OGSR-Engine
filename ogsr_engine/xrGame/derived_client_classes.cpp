...
CParticlesObject* monster_play_particles(CBaseMonster* monster, LPCSTR name, const Fvector& position,
                                         const Fvector& dir, BOOL auto_remove, BOOL xformed)
{
...
void COutfitScript::script_register(lua_State* L)
{
	...
	[
		...
		.property("radiation_protection", &get_protection<ALife::eHitTypeRadiation>,
		          &set_protection<ALife::eHitTypeRadiation>)
		.property("telepatic_protection", &get_protection<ALife::eHitTypeTelepatic>,
		          &set_protection<ALife::eHitTypeTelepatic>)
		.property("chemical_burn_protection", &get_protection<ALife::eHitTypeChemicalBurn>,
		          &set_protection<ALife::eHitTypeChemicalBurn>)
		.property("explosion_protection", &get_protection<ALife::eHitTypeExplosion>,
		          &set_protection<ALife::eHitTypeExplosion>)
		.property("fire_wound_protection", &get_protection<ALife::eHitTypeFireWound>,
		          &set_protection<ALife::eHitTypeFireWound>)
		.property("wound_2_protection", &get_protection<ALife::eHitTypeWound_2>,
		          &set_protection<ALife::eHitTypeWound_2>)
		.property("physic_strike_protection", &get_protection<ALife::eHitTypePhysicStrike>,
		          &set_protection<ALife::eHitTypePhysicStrike>)
	];
}
