...
bool CScriptGameObject::IsInRuck(CScriptGameObject* obj) const
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member is_in_ruck!");
		return (0);
	}
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryOwner : cannot access class member is_in_ruck!");
		return (0);
	}
...
bool CScriptGameObject::IsInSlot(CScriptGameObject* obj) const
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member is_in_slot!");
		return (0);
	}
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryOwner : cannot access class member is_in_slot!");
		return (0);
	}
...
void CScriptGameObject::MoveToRuck(CScriptGameObject* obj)
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member move_to_ruck!");
		return;
	}
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryOwner : cannot access class member move_to_ruck!");
		return;
	}
...
void CScriptGameObject::MoveToSlot(CScriptGameObject* obj, bool bNotActivate)
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member move_to_slot!");
		return;
	}
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryOwner : cannot access class member move_to_slot!");
		return;
	}
...
void CScriptGameObject::MoveToBelt(CScriptGameObject* obj)
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member move_to_belt!");
		return;
	}
...
void CScriptGameObject::InvalidateInventory()
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryOwner : cannot access class member InvalidateInventory!");
		return;
	}
...
flags16 CScriptGameObject::GetIIFlags()
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member GetIIFlags!");
		return flags16();
	}
...
void CScriptGameObject::SetIIFlags(flags16 flags)
{
	...
	{
		ai().script_engine().script_log(ScriptStorage::eLuaMessageTypeError,
		                                "CInventoryItem : cannot access class member SetIIFlags!");
		return;
	}
