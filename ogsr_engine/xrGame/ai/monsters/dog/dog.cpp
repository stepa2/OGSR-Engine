...
void CAI_Dog::Load(LPCSTR section)
{
	...
	m_corpse_use_timeout = (pSettings->line_exist(section, "corpse_use_timeout"))
		                       ? 1000 * pSettings->r_u32(section, "corpse_use_timeout")
		                       : 5000;
	m_min_sleep_time = (pSettings->line_exist(section, "min_sleep_time"))
		                   ? 1000 * pSettings->r_u32(section, "min_sleep_time")
		                   : 5000;
	m_min_life_time = (pSettings->line_exist(section, "min_life_time"))
		                  ? 1000 * pSettings->r_u32(section, "min_life_time")
		                  : 10000;
	m_drive_out_time = (pSettings->line_exist(section, "drive_out_time"))
		                   ? 1000 * pSettings->r_u32(section, "drive_out_time")
		                   : 10000;
	...
	pcstr anim_str = READ_IF_EXISTS(pSettings, r_string, section, "anim_stand_walk_smelling",
	                                "stand_walk_fwd_"/*"stand_walk_smelling_"*/);
	anim().AddAnim(eAnimHomeWalkSmelling, anim_str, -1, &velocity_walk_smell, PS_STAND);
	anim_str = READ_IF_EXISTS(pSettings, r_string, section, "anim_stand_growl_walk",
	                          "stand_walk_fwd_"/*"stand_growl_walk_"*/);
	...
	anim_extra_1 = READ_IF_EXISTS(pSettings, r_string, section, "anim_extra_1",
	                              "stand_idle_1"/*"stand_idle_smelling_up_0"*/);
	anim_extra_2 = READ_IF_EXISTS(pSettings, r_string, section, "anim_extra_2",
	                              "stand_idle_1"/*"stand_idle_smelling_down_0"*/);
	anim_extra_3 = READ_IF_EXISTS(pSettings, r_string, section, "anim_extra_3",
	                              "stand_idle_1"/*"stand_idle_smelling_look_around_0"*/);
	anim_extra_4 = READ_IF_EXISTS(pSettings, r_string, section, "anim_extra_4",
	                              "stand_idle_1"/*"stand_idle_dig_ground_0"*/);
...
void CAI_Dog::reload(LPCSTR section)
{
	...
	pcstr jump_ataka_02 = READ_IF_EXISTS(pSettings, r_string, section, "anim_jump_ataka_02",
	                                     "jump_right_0"/*"jump_ataka_02"*/);
