...
void CBurer::Load(LPCSTR section)
{
	...
	m_gravi.cooldown = READ_IF_EXISTS(pSettings, r_u32, section, "Gravi_Cooldown", 5000);
	m_gravi.min_dist = READ_IF_EXISTS(pSettings, r_float, section, "Gravi_MinDist", 1.f);
	m_gravi.max_dist = READ_IF_EXISTS(pSettings, r_float, section, "Gravi_MaxDist", 15.f);
	...
	pcstr shield_anim_start = READ_IF_EXISTS(pSettings, r_string, section, "shield_animation_start",
	                                         "stand_tele_"/*"stand_shield_"*/);
	anim().AddAnim(eAnimShieldStart, shield_anim_start, -1, &velocity_turn, PS_STAND);
	//, 	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
	pcstr shield_anim_cont = READ_IF_EXISTS(pSettings, r_string, section, "shield_animation_cont",
	                                        "stand_tele_"/*"stand_shield_idle_"*/);
	anim().AddAnim(eAnimShieldContinue, shield_anim_cont, -1, &velocity_turn, PS_STAND);
	//, 	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");

	pcstr tele_anim_fire = READ_IF_EXISTS(pSettings, r_string, section, "tele_animation_fire",
	                                      "stand_tele_"/*"stand_power_attack_"*/);
	anim().AddAnim(eAnimTeleFire, tele_anim_fire, -1, &velocity_turn, PS_STAND);
	//, 	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
	pcstr tele_anim_tele = READ_IF_EXISTS(pSettings, r_string, section, "tele_animation_tele",
	                                      "stand_tele_"/*"telekinesis_"*/);
	anim().AddAnim(eAnimTelekinesis, tele_anim_tele, -1, &velocity_turn, PS_STAND);
	//, 	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");
	pcstr gravi_anim_fire = READ_IF_EXISTS(pSettings, r_string, section, "gravi_animation_fire",
	                                       "stand_gravi_"/*"stand_power_attack_"*/);
	anim().AddAnim(eAnimGraviFire, gravi_anim_fire, -1, &velocity_turn, PS_STAND);
	//, 	"fx_stand_f", "fx_stand_b", "fx_stand_l", "fx_stand_r");

	pcstr run_anim_tl = READ_IF_EXISTS(pSettings, r_string, section, "run_animation_tl",
	                                   "stand_run_fwd_"/*"stand_run_fwd_turn_left_"*/);
	anim().AddAnim(eAnimRunTurnLeft, run_anim_tl, -1, &velocity_run, PS_STAND);
	pcstr run_anim_tr = READ_IF_EXISTS(pSettings, r_string, section, "run_animation_tr",
	                                   "stand_run_fwd_"/*"stand_run_fwd_turn_right_"*/);
