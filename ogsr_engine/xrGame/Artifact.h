...
public:
	...
	void onMovementChanged(ACTOR_DEFS::EMoveCommand cmd) override;
	void OnStateSwitch(u32 S) override;
	void OnAnimationEnd(u32 state) override;
	bool IsHidden() const override { return GetState() == eHidden; }
	u16 bone_count_to_synchronize() const override;
