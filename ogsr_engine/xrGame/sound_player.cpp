                        ...
                        u32 id)
{
	...
	{
		MsgDbg("- There are no sounds in sound collection \"%s%s\" with internal type %d (sound_script = %d)",
		       *sound.m_sound_player_prefix, *sound.m_sound_prefix, internal_type, StalkerSpace::eStalkerSoundScript);
		return;
	}
