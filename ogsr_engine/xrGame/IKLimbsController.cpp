...
void CIKLimbsController::Create(CGameObject* O)
{
	...
	{
		u16 bones[4] = {
			K->LL_BoneID("bip01_l_upperarm"), K->LL_BoneID("bip01_l_forearm"), K->LL_BoneID("bip01_l_hand"),
	...
	{
		u16 bones[4] = {
			K->LL_BoneID("bip01_r_upperarm"), K->LL_BoneID("bip01_r_forearm"), K->LL_BoneID("bip01_r_hand"),
	...
	{
		u16 bones[4] = {
			K->LL_BoneID("bip01_l_thigh"), K->LL_BoneID("bip01_l_calf"), K->LL_BoneID("bip01_l_foot"),
	...
	{
		u16 bones[4] = {
			K->LL_BoneID("bip01_r_thigh"), K->LL_BoneID("bip01_r_calf"), K->LL_BoneID("bip01_r_foot"),
...
void CIKLimbsController::LimbSetup(const u16 bones[4])
{
	...
	_bone_chains.back().Create((u16)_bone_chains.size() - 1, skeleton_animated, bones, toe, true);
	//Fvector( ).set( 0.13143f, 0, 0.20f )
}
