...
class_<CScriptGameObject> script_register_game_object3(class_<CScriptGameObject>&& instance)
{
	return std::move(instance)
	       ...
	       .def("ph_capture_object",
	            (void ( CScriptGameObject::*)(CScriptGameObject*))(&CScriptGameObject::PHCaptureObject))
	       .def("ph_capture_object",
	            (void ( CScriptGameObject::*)(CScriptGameObject*, LPCSTR))(&CScriptGameObject::PHCaptureObject))
	       .def("ph_capture_object",
	            (void ( CScriptGameObject::*)(CScriptGameObject*, u16))(&CScriptGameObject::PHCaptureObject))
	       .def("ph_capture_object",
	            (void ( CScriptGameObject::*)(CScriptGameObject*, u16, LPCSTR))(&CScriptGameObject::PHCaptureObject))
	       .def("ph_release_object", &CScriptGameObject::PHReleaseObject)
	       .def("ph_capture", &CScriptGameObject::PHCapture)

	       .def("throw_target",
	            (bool ( CScriptGameObject::*)(const Fvector&, CScriptGameObject*))(&CScriptGameObject::throw_target))
	       .def("throw_target",
	            (bool ( CScriptGameObject::*)(const Fvector&, u32 const, CScriptGameObject*))(&CScriptGameObject::
		            throw_target))
	       ...
	       .def("stalker_disp_base",
	            (void ( CScriptGameObject::*)(float, float))(&CScriptGameObject::stalker_disp_base))
