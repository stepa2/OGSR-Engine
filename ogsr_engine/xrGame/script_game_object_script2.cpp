...
class_<CScriptGameObject> script_register_game_object1(class_<CScriptGameObject>&& instance)
{
	return std::move(instance)
		...
		.def("set_home",
		     (void ( CScriptGameObject::*)(LPCSTR, float, float, bool, float))(&CScriptGameObject::set_home))
		...
		.def("set_home",
		     (void ( CScriptGameObject::*)(CPatrolPath*, float, float, bool, float))(&CScriptGameObject::set_home))
